...
Ya viene precargado con las 42 entradas shortlisteadas de marcas Bavaria en
2026 (de `Effie_2026.xlsx`), todas en estado "Finalista". A medida que se
anuncien los metales en la ceremonia, se actualizan a Bronce / Plata / Oro /
Gran Effie y el marcador recalcula los puntos solo.
...
- `data/seed-entries.json` — las 42 entradas shortlisteadas de Bavaria en
  2026, con el metal en "Finalista" hasta que se actualicen.
